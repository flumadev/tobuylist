...
export function Sidebar() {
  ...
  return (
    <div className="hidden sticky top-[65px] lg:top-[81px] h-[calc(100svh-65px)] lg:h-[calc(100svh-81px)] overflow-y-hidden w-[300px] md:flex flex-col  p-6 shrink-0 border-l border-l-slate-200  dark:border-l-slate-700">
